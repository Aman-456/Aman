    ...
    <div className={`container-f ${styles.Aboutme}`}>
      <div className="container">
        ...
        <div className={`container-f ${styles.main__content}`}>
          ...
          <h2 className={`${styles.h2} textcenter `}>
            i am AmanUllah <br /> I can give your business a new creative start right away !
          </h2>
          <div className={`${styles.para}`}>{aboutme}</div>

          <div className={`mt ${styles.img}`}>
            <img src={list.laptop} alt="" />
          </div>

          <div className="mt">{/* <RecentWork black /> */}</div>
          <div className="mt">
            <CTA />
          </div>
        </div>
